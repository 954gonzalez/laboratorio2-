...
Principal miPrincipal=new Principal();
	...
	public Principal() {
		flecha1=new Flecha();
		flecha1.longitud=Integer.parseInt(JOptionPane.showInputDialog("ingrese la longitd")) ;
		flecha1.construirFlecha();
		flecha1.imprimirEspacio();
		
		
		flecha2=new Flecha();
		flecha2.longitud=Integer.parseInt(JOptionPane.showInputDialog("ingrese la longitd")) ;
		flecha2.color="rojo";
